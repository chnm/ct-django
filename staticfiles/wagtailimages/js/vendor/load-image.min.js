!(function (e) {
  ...
  (t.isInstanceOf = function (e, t) {
    ...
    (t.scale = function (e, i) {
      ...
      return (
        f &&
          ((l = (i = t.getTransformedOptions(i)).left || 0),
          (c = i.top || 0),
          i.sourceWidth
            ? ((s = i.sourceWidth),
    ...
    (t.createObjectURL = function (e) {
      return !!i && i.createObjectURL(e);
    }),
    (t.revokeObjectURL = function (e) {
      return !!i && i.revokeObjectURL(e);
    }),
  ...
  (function (e) {
    ...
    if (
      ...
      (e.detectSubsampling = function (e) {
        var t, i;
        return (
          e.width * e.height > 1048576 &&
          (((t = document.createElement("canvas")).width = t.height = 1),
          (i = t.getContext("2d")).drawImage(e, 1 - e.width, 0),
        ...
        if (r)
          switch ((r > 4 && ((e.width = n), (e.height = a)), r)) {
            ...
            case 5:
              ...
              break;
            case 6:
              i.rotate(0.5 * Math.PI), i.translate(0, -n);
              break;
            case 7:
              i.rotate(0.5 * Math.PI), i.translate(a, -n), i.scale(-1, 1);
              break;
            case 8:
      ...
      (e.getTransformedOptions = function (e) {
        ...
        return (
          e.orientation > 4 &&
            ...
            (i.maxHeight = e.maxWidth),
            (i.minWidth = e.minHeight),
            (i.minHeight = e.minWidth),
            (i.sourceWidth = e.sourceHeight),
            (i.sourceHeight = e.sourceWidth)),
          i
        );
      });
  }),
            ...
            function (t) {
              ...
              if (65496 === u.getUint16(0)) {
                for (
                  ;
                  f > g &&
                  (((r = u.getUint16(g)) >= 65504 && 65519 >= r) ||
                    65534 === r);

                ) {
                  if (g + (s = u.getUint16(g + 2) + 2) > u.byteLength) {
    ...
    (e.ExifMap = function () {
      ...
      (e.getExifValue = function (t, i, a, n, r, o) {
        ...
        if (f) {
          if (
            !(
              (d = (s = f.size * r) > 4 ? i + t.getUint32(a + 8, o) : a + 8) +
                s >
              t.byteLength
            )
          ) {
            ...
            if (f.ascii) {
              for (u = "", c = 0; c < l.length && "\0" !== (g = l[c]); c += 1)
                u += g;
              return u;
            }
            return l;
      ...
      (e.parseExifTags = function (e, t, i, a, n) {
        ...
        if (i + 6 > e.byteLength)
          ...
          if (
            !((o = i + 2 + 12 * (r = e.getUint16(i, a))) + 4 > e.byteLength)
          ) {
            for (s = 0; r > s; s += 1)
