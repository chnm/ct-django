    ...
    e.widget("blueimp.fileupload", e.blueimp.fileupload, {
      ...
      processActions: {
        validate: function (i, l) {
          if (l.disabled) return i;
          var r,
            s = e.Deferred(),
            t = this.options,
            o = i.files[i.index];
          return (
            (l.minFileSize || l.maxFileSize) && (r = o.size),
            "number" === e.type(l.maxNumberOfFiles) &&
            (t.getNumberOfFiles() || 0) + i.files.length > l.maxNumberOfFiles
              ? (o.error = t.i18n("maxNumberOfFiles"))
              : !l.acceptFileTypes ||
                l.acceptFileTypes.test(o.type) ||
                l.acceptFileTypes.test(o.name)
              ? r > l.maxFileSize
                ? (o.error = t.i18n("maxFileSize"))
                : "number" === e.type(r) && r < l.minFileSize
