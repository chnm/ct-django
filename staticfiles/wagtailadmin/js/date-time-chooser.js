    ...
    t = {
      1712: (e, t, n) => {
        ...
        (i().fn.datetimepicker.defaults.i18n.wagtail_custom_locale = {
          ...
          i().datetimepicker.setLocale("wagtail_custom_locale"),
          (window.dateEqual = o),
          (window.hideCurrent = r),
          (window.initDateChooser = function (e, t) {
                  ...
                  i().extend(
                    {
                      ...
                      format: "Y-m-d",
                      onGenerate: r,
                      onChangeDateTime(e, t) {
                        t.get(0).dispatchEvent(
          ...
          (window.initTimeChooser = function (e, t) {
            window.dateTimePickerTranslations
              ? i()("#" + e).datetimepicker(
                  i().extend(
                    {
          ...
          (window.initDateTimeChooser = function (e, t) {
            window.dateTimePickerTranslations
              ? i()("#" + e).datetimepicker(
                  i().extend(
                    {
    ...
    (a.O = (t, n, i, o) => {
      if (!n) {
        ...
        for (s = 0; s < e.length; s++) {
          for (var [n, i, o] = e[s], d = !0, l = 0; l < n.length; l++)
            (!1 & o || r >= o) && Object.keys(a.O).every((e) => a.O[e](n[l]))
              ? n.splice(l--, 1)
              : ((d = !1), o < r && (r = o));
          if (d) {
            e.splice(s--, 1);
