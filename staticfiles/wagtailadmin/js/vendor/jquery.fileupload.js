  ...
  (e.support.fileInput = !(
    ...
    e.widget("blueimp.fileupload", {
      ...
      _initProgressListener: function (t) {
        ...
        r.upload &&
          (e(r.upload).on("progress", function (e) {
      ...
      _getXHRPromise: function (t, i, r) {
        ...
        return (
          ...
          !0 === t ? n.resolveWith(i, r) : !1 === t && n.rejectWith(i, r),
          (o.abort = n.promise),
      ...
      _chunkedUpload: function (t, i) {
        ...
        var r,
          ...
          h = d.promise();
        return (
          !(!(this._isXHRUpload(t) && u && (l || p < a)) || t.data) &&
          (!!i ||
            (l >= a
              ...
              : ((n = function () {
                  ...
                  (i.blob = u.call(s, l, l + p, s.type)),
                    ...
                    (r = (
                      (!1 !== o._trigger("chunksend", null, i) && e.ajax(i)) ||
                      ...
                      .done(function (r, s, p) {
                        (l = o._getUploadedBytes(p) || l + i.chunkSize),
                          ...
                          l < a ? n() : d.resolveWith(i.context, [r, s, p]);
                      })
                      .fail(function (e, t, r) {
                        (i.jqXHR = e),
                          (i.textStatus = t),
        ...
        return (
          ...
          (this.options.limitConcurrentUploads &&
            ...
            ? (this.options.limitConcurrentUploads > 1
                ? ((o = e.Deferred()), this._slots.push(o), (s = o.then(p)))
      ...
      _onAdd: function (t, i) {
        var r,
          ...
          f = p.limitMultiFileUploadSize,
          c = p.limitMultiFileUploadSizeOverhead,
          g = 0,
          _ = this._getParamName(p),
          m = 0;
        if (
          (!f || (d && void 0 !== u[0].size) || (f = void 0),
          (p.singleFileUploads || h || f) && this._isXHRUpload(p))
        )
          if (p.singleFileUploads || f || !h)
            if (!p.singleFileUploads && f)
              for (o = [], r = [], s = 0; s < d; s += 1)
                (g += u[s].size + c),
                  (s + 1 === d ||
                    g + u[s + 1].size + c > f ||
      ...
      _handleFileTreeEntry: function (t, i) {
        ...
        return (
          ...
          t.isFile
            ...
            : t.isDirectory
            ? t.createReader().readEntries(function (e) {
      ...
      _onDragOver: function (t) {
        ...
        i &&
          -1 !== e.inArray("Files", i.types) &&
          !1 !==
            this._trigger(
              "dragover",
              e.Event("dragover", { delegatedEvent: t }),
            ) &&
          (t.preventDefault(), (i.dropEffect = "copy"));
      },
