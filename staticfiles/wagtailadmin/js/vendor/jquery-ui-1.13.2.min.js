...
!(function (t) {
  ...
  var e,
    ...
    p,
    f = 0,
    g = Array.prototype.hasOwnProperty,
  ...
  (t.cleanData =
    ...
    (t.widget.extend = function (e) {
      for (var i, s, n = m.call(arguments, 1), o = 0, a = n.length; o < a; o++)
        for (i in n[o])
          (s = n[o][i]),
            g.call(n[o], i) &&
              void 0 !== s &&
            ...
            (a = s.classesElementLookup[n[r]] || t()),
              (a = e.add
                ? ((function () {
                  ...
                  t(t.uniqueSort(a.get().concat(e.element.get()))))
        ...
        "boolean" != typeof e && ((s = i), (i = e), (e = !1)),
          ...
          t.each(s, function (s, a) {
            ...
            "string" != typeof a &&
              ...
              (s = (l = s.match(/^([\w:-]*)\s*(.*)$/))[1] + o.eventNamespace),
              (l = l[2]) ? n.on(s, l, r) : i.on(s, r);
          });
      },
      _off: function (e, i) {
        (i =
    ...
    t.each({ show: "fadeIn", hide: "fadeOut" }, function (e, i) {
      t.Widget.prototype["_" + e] = function (s, n, o) {
        var a,
          r = (n = "string" == typeof n ? { effect: n } : n)
    ...
    (t.position = {
      scrollbarWidth: function () {
        ...
        return (
          ...
          e === (n = n.offsetWidth) && (n = s[0].clientWidth),
          s.remove(),
          (i = e - n)
        );
      },
    ...
    (t.fn.position = function (e) {
      ...
      return (
        g[0].preventDefault && (e.at = "left top"),
        (h = k.width),
        (u = k.height),
          ...
          ((s =
            1 === s.length
              ? o.test(s[0])
                ...
                ? ["center"].concat(s)
                : ["center", "center"]
              : s)[0] = o.test(s[0]) ? s[0] : "center"),
            (s[1] = a.test(s[1]) ? s[1] : "center"),
            (t = r.exec(s[0])),
            (i = r.exec(s[1])),
        ...
        this.each(function () {
          var o,
            ...
            f = v(this, "marginLeft"),
            b = v(this, "marginTop"),
            k = l + f + v(this, "marginRight") + y.width,
            C = c + b + v(this, "marginBottom") + y.height,
            D = t.extend({}, p),
            I = _(x.my, r.outerWidth(), r.outerHeight());
          "right" === e.my[0]
            ? (D.left -= l)
            : "center" === e.my[0] && (D.left -= l / 2),
            "bottom" === e.my[1]
              ? (D.top -= c)
              : "center" === e.my[1] && (D.top -= c / 2),
            (D.left += I[0]),
            (D.top += I[1]),
            (o = { marginLeft: f, marginTop: b }),
            t.each(["left", "top"], function (s, n) {
              t.ui.position[w[s]] &&
                t.ui.position[w[s]][n](D, {
                  targetWidth: h,
                  targetHeight: u,
                  elemWidth: l,
                  elemHeight: c,
              ...
              (a = function (t) {
                var i = d.left - D.left,
                  ...
                  f = {
                    ...
                    vertical: p < 0 ? "top" : 0 < a ? "bottom" : "middle",
                  };
                h < l && n(i + o) < h && (f.horizontal = "center"),
                  u < c && n(a + p) < u && (f.vertical = "middle"),
                  s(n(i), n(o)) > s(n(a), n(p))
                    ? (f.important = "horizontal")
                    : (f.important = "vertical"),
                  e.using.call(this, t, f);
              }),
            r.offset(t.extend(D, { using: a }));
        })
      );
    }),
    (t.ui.position = {
      ...
      flip: {
        left: function (t, e) {
          var i = (h = e.within).offset.left + h.scrollLeft,
            ...
            a = (c = t.left - e.collisionPosition.marginLeft) - o,
            r = c + e.collisionWidth - s - o,
            l =
              "left" === e.my[0]
                ? -e.elemWidth
                : "right" === e.my[0]
            ...
            c = -2 * e.offset[0];
          a < 0
            ? ((i = t.left + l + h + c + e.collisionWidth - s - i) < 0 ||
                i < n(a)) &&
              (t.left += l + h + c)
            : 0 < r &&
              (0 <
                (o = t.left - e.collisionPosition.marginLeft + l + h + c - o) ||
                n(o) < r) &&
              (t.left += l + h + c);
        },
        top: function (t, e) {
          var i = (h = e.within).offset.top + h.scrollTop,
            ...
            a = (c = t.top - e.collisionPosition.marginTop) - o,
            r = c + e.collisionHeight - s - o,
            l =
              "top" === e.my[1]
                ? -e.elemHeight
                : "bottom" === e.my[1]
            ...
            c = -2 * e.offset[1];
          a < 0
            ? ((i = t.top + l + h + c + e.collisionHeight - s - i) < 0 ||
                i < n(a)) &&
              (t.top += l + h + c)
            : 0 < r &&
              (0 <
      ...
      disableSelection:
        ((u =
          "onselectstart" in document.createElement("div")
            ...
            : "mousedown"),
        function () {
          return this.on(u + ".ui-disableSelection", function (t) {
            t.preventDefault();
          });
        }),
    ...
    (t.fn.scrollParent = function (e) {
      ...
      return (
        (e = this.parents()
          ...
          .eq(0)),
        "fixed" !== i && e.length ? e : t(this[0].ownerDocument || document)
      );
    }),
    t.extend(t.expr.pseudos, {
      tabbable: function (e) {
  ...
  t(document).on("mouseup", function () {
      ...
      drag: function (e, i, s) {
        for (
          var n,
            ...
            f = p.snapTolerance,
            g = i.offset.left,
            m = g + s.helperProportions.width,
            _ = i.offset.top,
            v = _ + s.helperProportions.height,
            b = s.snapElements.length - 1;
          0 <= b;
          b--
        )
          (h =
            (l = s.snapElements[b].left - s.margins.left) +
            s.snapElements[b].width),
            (u =
              (c = s.snapElements[b].top - s.margins.top) +
              s.snapElements[b].height),
            m < l - f ||
            h + f < g ||
            v < c - f ||
            u + f < _ ||
            !t.contains(
              s.snapElements[b].item.ownerDocument,
              s.snapElements[b].item,
            )
              ? (s.snapElements[b].snapping &&
                  s.options.snap.release &&
                  s.options.snap.release.call(
                    s.element,
                    e,
                    t.extend(s._uiHash(), { snapItem: s.snapElements[b].item }),
                  ),
                (s.snapElements[b].snapping = !1))
              : ("inner" !== p.snapMode &&
                  ((n = Math.abs(c - v) <= f),
                  (o = Math.abs(u - _) <= f),
                  (a = Math.abs(l - m) <= f),
                ...
                (s.snapElements[b].snapping = n || o || a || r || d));
      },
    }),
    t.ui.plugin.add("draggable", "stack", {
      start: function (e, i, s) {
        ...
        (s = s.options),
          ...
          s.length &&
            ((n = parseInt(t(s[0]).css("zIndex"), 10) || 0),
            t(s).each(function (e) {
    ...
    t.widget("ui.droppable", {
      ...
      _setOption: function (e, i) {
        ...
        "accept" === e
          ...
          : "scope" === e &&
            ((s = t.ui.ddmanager.droppables[this.options.scope]),
            this._splice(s),
    ...
    (t.ui.intersect = function (t, e, i, s) {
      ...
      switch (i) {
        ...
        case "pointer":
          return (
            x(s.pageY, h, e.proportions().height) &&
            x(s.pageX, l, e.proportions().width)
          );
        case "touch":
          return (
          ...
          this._helper &&
            ((n =
              ...
              this._hasScroll(s[0], "left")
                ? 0
                : a.sizeDiff.height),
            (s = i ? 0 : a.sizeDiff.width),
            (i = {
              width: a.helper.width() - s,
            ...
            o.animate || this.element.css(t.extend(i, { top: n, left: s })),
    ...
    t.ui.plugin.add("resizable", "animate", {
      stop: function (e) {
        ...
        (a =
          ...
          i.element.animate(t.extend(r, o && a ? { top: o, left: a } : {}), {
    ...
    t.ui.plugin.add("resizable", "containment", {
        ...
        r &&
          ...
          /document/.test(a) || a === document
            ...
            : ((e = t(r)),
              ...
              (n = s.containerOffset),
              (o = s.containerSize.height),
              (a = s.containerSize.width),
              (a = s._hasScroll(r, "left") ? r.scrollWidth : a),
              (o = s._hasScroll(r) ? r.scrollHeight : o),
              (s.parentData = {
                element: r,
                left: n.left,
                top: n.top,
      ...
      resize: function (e) {
        ...
        (e = !0),
          ...
          (o = Math.abs(
            i.sizeDiff.width +
              (i._helper ? i.offset.left - r.left : i.offset.left - n.left),
          )),
          (n = Math.abs(
            i.sizeDiff.height +
              (i._helper ? i.offset.top - r.top : i.offset.top - n.top),
          )),
      ...
      stop: function () {
        var e = t(this).resizable("instance"),
          ...
          a = (l = t(e.helper)).offset(),
          r = l.outerWidth() - e.sizeDiff.width,
          l = l.outerHeight() - e.sizeDiff.height;
        e._helper &&
          !i.animate &&
          /relative/.test(o.css("position")) &&
          t(this).css({ left: a.left - n.left - s.left, width: r, height: l }),
          e._helper &&
            !i.animate &&
          ...
          (this.refresh = function () {
            (e.elementPos = t(e.element[0]).offset()),
              ...
              e.selectees.each(function () {
                var i = t(this),
                  s = {
                    left: (s = i.offset()).left - e.elementPos.left,
    ...
    t.widget("ui.sortable", t.ui.mouse, {
      ...
      _mouseCapture: function (e, i) {
        ...
        return !(
          ...
          !(s =
            t.data(e.target, o.widgetName + "-item") === o ? t(e.target) : s) ||
            (this.options.handle &&
              !i &&
      ...
      _getItemsAsjQuery: function (e) {
        ...
        if (l && e)
          for (i = l.length - 1; 0 <= i; i--)
            for (s = (n = t(l[i], this.document[0])).length - 1; 0 <= s; s--)
      ...
      _refreshItems: function (e) {
        ...
        if (d && this.ready)
          for (i = d.length - 1; 0 <= i; i--)
            for (s = (n = t(d[i], this.document[0])).length - 1; 0 <= s; s--)
              (o = t.data(n[s], this.widgetFullName)) &&
                o !== this &&
                !o.options.disabled &&
                (u.push([
        ...
        for (i = u.length - 1; 0 <= i; i--)
          for (a = u[i][1], h = (r = u[i][(s = 0)]).length; s < h; s++)
        ...
        (r = {
          ...
          (o && !i.collapsible) ||
            ...
            o ||
              ...
              i.icons &&
                ((o = n.children(".ui-accordion-header-icon")),
        ...
        return (
          ...
          e.length
            ? t.length
              ...
              : e.animate(this.hideProps, o, n, h)
    ...
    t.widget("ui.menu", {
        ...
        this._toggleClass(
          ...
          (i = o
            ...
            .each(function () {
              ...
              s._addClass(o, "ui-menu-icon", "ui-icon " + n),
      ...
      _scrollIntoView: function (e) {
        ...
        this._hasScroll() &&
          ...
          (i = e.offset().top - this.activeMenu.offset().top - s - n),
          (s = this.activeMenu.scrollTop()),
          (n = this.activeMenu.height()),
          (e = e.outerHeight()),
          i < 0
            ? this.activeMenu.scrollTop(s + i)
            : n < i + e && this.activeMenu.scrollTop(s + i - n + e));
      },
      blur: function (t, e) {
    ...
    t.widget("ui.autocomplete", {
      ...
      _create: function () {
        var e,
          i,
          s,
          n = "textarea" === (o = this.element[0].nodeName.toLowerCase()),
          o = "input" === o;
        (this.isMultiLine = n || (!o && this._isContentEditable(this.element))),
          ...
          this._on(this.element, {
            keydown: function (n) {
              if (this.element.prop("readOnly")) i = s = e = !0;
              else {
                i = s = e = !1;
                var o = t.ui.keyCode;
                switch (n.keyCode) {
  ...
  t.widget("ui.controlgroup", {
            ...
            : void (
                ...
                e.element.find(n).each(function () {
                  ...
                  ("button" === s && n.parent(".ui-spinner").length) ||
                    ...
                    n[s](r),
                    (r = n[s]("widget")),
                    t.data(r[0], "ui-controlgroup-data", o || n[s]("instance")),
                    i.push(r[0]));
                }))
              );
      }),
    ...
    _resolveClassesValues: function (e, i) {
      ...
      return (
        t.each(e, function (t) {
          ...
          (n = String.prototype.trim.call(n.replace(I, ""))),
      ...
      this._addClass(
        ...
        (e = this.options.onlyVisible ? e.filter(":visible") : e).length &&
          (t.each(["first", "last"], function (t, s) {
            var n,
              o = e[s]().data("ui-controlgroup-data");
            o && i["_" + o.widgetName + "Options"]
              ? (((n = i["_" + o.widgetName + "Options"](
                  1 === e.length ? "only" : s,
                )).classes = i._resolveClassesValues(n.classes, o)),
                o.element[o.widgetName](n))
            ...
            i
              ...
              : (s.length && (e = t.widget.extend.apply(null, [e].concat(s))),
                this.each(function () {
                  var i,
                    s =
                      "checkbox" !== (i = t(this).attr("type")) && "radio" !== i
                        ? "button"
                        : "checkboxradio";
                  (i = t.data(this, "ui-" + s))
    ...
    t.extend(T.prototype, {
      ...
      _attachments: function (e, i) {
        ...
        i.append && i.append.remove(),
          n &&
            ((i.append = t("<span>").addClass(this._appendClass).text(n)),
          ...
          ("button" !== s && "both" !== s) ||
            ...
            this._get(i, "buttonImageOnly")
              ...
              : ((i.trigger = t("<button type='button'>").addClass(
                ...
                s
                  ? i.trigger.html(
                      t("<img>").attr({ src: s, alt: n, title: n }),
                    )
                  : i.trigger.text(n)),
      ...
      _dialogDatepicker: function (e, i, s, n, o) {
        ...
        return (
          r ||
            ...
            t.data(this._dialogInput[0], "datepicker", r)),
          S(r.settings, n || {}),
          (i = i && i.constructor === Date ? this._formatDate(r, i) : i),
      ...
      _optionDatepicker: function (e, i, s) {
        ...
        (n = i || {}),
          ...
          a &&
            ...
            (i = this._getMinMaxDate(a, "min")),
            (s = this._getMinMaxDate(a, "max")),
            S(a.settings, n),
            null !== i &&
              void 0 !== n.dateFormat &&
              void 0 === n.minDate &&
              (a.settings.minDate = this._formatDate(a, i)),
            null !== s &&
              void 0 !== n.dateFormat &&
              void 0 === n.maxDate &&
          ...
          switch (e.keyCode) {
            ...
            case 13:
              return (
                ...
                (i = t.datepicker._get(n, "onSelect"))
                  ? ((s = t.datepicker._formatDate(n)),
            ...
            case 33:
              t.datepicker._adjustDate(
                e.target,
                e.ctrlKey
                  ? -t.datepicker._get(n, "stepBigMonths")
                  : -t.datepicker._get(n, "stepMonths"),
                "M",
              );
              break;
            case 34:
      ...
      _doKeyPress: function (e) {
        ...
        if (t.datepicker._get(s, "constrainInput"))
          return (
            ...
            e.ctrlKey || e.metaKey || s < " " || !i || -1 < i.indexOf(s)
          );
      },
      _doKeyUp: function (e) {
      ...
      _showDatepicker: function (e) {
        ...
        "input" !== (e = e.target || e).nodeName.toLowerCase() &&
          ...
          t.datepicker._isDisabledDatepicker(e) ||
            ...
            !1 !==
              (s = (n = t.datepicker._get(o, "beforeShow"))
                ? n.apply(e, [e, o])
                : {}) &&
              (S(o.settings, s),
              (o.lastVal = null),
              ...
              (n = { left: t.datepicker._pos[0], top: t.datepicker._pos[1] }),
              ...
              (n = t.datepicker._checkOffset(o, n, i)),
              o.dpDiv.css({
                position:
              ...
              o.inline ||
                ((s = t.datepicker._get(o, "showAnim")),
                (n = t.datepicker._get(o, "duration")),
                o.dpDiv.css(
                  "z-index",
                  (function (t) {
                ...
                t.effects && t.effects.effect[s]
                  ? o.dpDiv.show(s, t.datepicker._get(o, "showOptions"), n)
                  : o.dpDiv[s || "show"](s ? n : null),
                t.datepicker._shouldFocusInput(o) && o.input.trigger("focus"),
                (t.datepicker._curInst = o))));
      },
      _updateDatepicker: function (e) {
        (this.maxRows = 4),
          (C = e).dpDiv.empty().append(this._generateHTML(e)),
      ...
      _findPos: function (e) {
        for (
          var i = this._getInst(e), s = this._get(i, "isRTL");
          e &&
        ...
        !n ||
          ...
          (this._datepickerShowing &&
            ...
            t.effects && (t.effects.effect[i] || t.effects[i])
              ? n.dpDiv.hide(i, t.datepicker._get(n, "showOptions"), s, e)
              : n.dpDiv[
                  "slideDown" === i
                    ? "slideUp"
                    : "fadeIn" === i
            ...
            i || e(),
            (this._datepickerShowing = !1),
            (e = this._get(n, "onClose")) &&
              e.apply(n.input ? n.input[0] : null, [
                n.input ? n.input.val() : "",
                n,
              ]),
      ...
      _adjustDate: function (e, i, s) {
        ...
        (e = this._getInst(n[0])),
          this._isDisabledDatepicker(n[0]) ||
            (this._adjustInstDate(e, i, s), this._updateDatepicker(e));
      },
      ...
      _selectDate: function (e, i) {
        ...
        (e = this._getInst(s[0])),
          ...
          (s = this._get(e, "onSelect"))
            ? s.apply(e.input ? e.input[0] : null, [i, e])
      ...
      _updateAlternate: function (e) {
        ...
        n &&
          ...
          (s = this._getDate(e)),
          (e = this.formatDate(i, s, this._getFormatConfig(e))),
          t(document).find(n).val(e));
      },
      ...
      parseDate: function (e, i, s) {
          ...
          var n,
            ...
            y = function (e, s, n) {
              ...
              if (
                ...
                t.each(s, function (t, e) {
                  var s = e[1];
                  if (i.substr(r, s.length).toLowerCase() === s.toLowerCase())
                    return (o = e[0]), (r += s.length), !1;
                }),
                -1 !== o)
              )
                return o + 1;
        ...
        if (r < i.length && ((o = i.substr(r)), !/^\s+/.test(o)))
        ...
        if (
          ...
          for (f = 1, g = m; !(g <= (n = this._getDaysInMonth(p, f - 1))); )
            f++, (g -= n);
        if (
        ...
        return (
          (i =
            null == i || "" === i
              ...
              ? isNaN(i)
                ? s
                : ((n = i), (o = new Date()).setDate(o.getDate() + n), o)
              : new Date(i.getTime())),
      ...
      _generateHTML: function (e) {
        var i,
          ...
          B = ((O = this._get(e, "stepMonths")), 1 !== R[0] || 1 !== R[1]),
        ...
        if ((U < 0 && ((U += 12), V--), K))
          for (
            i = this._daylightSavingAdjust(
              new Date(
                K.getFullYear(),
                K.getMonth() - R[0] * R[1] + 1,
                K.getDate(),
              ),
            ),
              i = q && i < q ? q : i;
            this._daylightSavingAdjust(new Date(V, U, 1)) > i;
        ...
        for (
          e.drawMonth = U,
            e.drawYear = V,
            Y = this._get(e, "prevText"),
            Y = L
              ? this.formatDate(
                  Y,
                  this._daylightSavingAdjust(new Date(V, U - O, 1)),
                  this._getFormatConfig(e),
                )
              : Y,
            s = this._canAdjustMonth(e, -1, V, U)
              ? t("<a>")
                  .attr({
                  ...
                  .append(
                    t("<span>")
                      .addClass(
                        "ui-icon ui-icon-circle-triangle-" + (E ? "e" : "w"),
                      )
                      .text(Y),
                  )[0].outerHTML
              : F
            ...
            Y = L
              ...
              : Y,
            n = this._canAdjustMonth(e, 1, V, U)
              ? t("<a>")
                  .attr({
                  ...
                  .append(
                    t("<span>")
                      .addClass(
                        "ui-icon ui-icon-circle-triangle-" + (E ? "w" : "e"),
                      )
                      .text(Y),
                  )[0].outerHTML
              : F
            ...
            F = this._get(e, "gotoCurrent") && e.currentDay ? j : N,
            O = L ? this.formatDate(O, F, this._getFormatConfig(e)) : O,
            Y = "",
            e.inline ||
              (Y = t("<button>")
                .attr({
            ...
            L = "",
            W &&
              (L = t("<div class='ui-datepicker-buttonpane ui-widget-content'>")
                .append(E ? Y : "")
                .append(
                  this._isInRange(e, F)
                    ? t("<button>")
          ...
          for (v = "", this.maxRows = 4, b = 0; b < R[1]; b++) {
            if (
              ((y = this._daylightSavingAdjust(new Date(V, U, e.selectedDay))),
              (w = " ui-corner-all"),
              (x = ""),
              B)
            ) {
                ...
                switch (b) {
                  case 0:
                    (x += " ui-datepicker-group-first"),
                      (w = " ui-corner-" + (E ? "right" : "left"));
                    break;
                  case R[1] - 1:
                    (x += " ui-datepicker-group-last"),
                      (w = " ui-corner-" + (E ? "left" : "right"));
                    break;
                  default:
            ...
            for (
              x +=
                ...
                w +
                "'>" +
                (/all|left/.test(w) && 0 === _ ? (E ? n : s) : "") +
                (/all|right/.test(w) && 0 === _ ? (E ? s : n) : "") +
            ...
            for (
              x += k + "</tr></thead><tbody>",
                I = this._getDaysInMonth(V, U),
                V === e.selectedYear &&
                  U === e.selectedMonth &&
                  (e.selectedDay = Math.min(e.selectedDay, I)),
                D = (this._getFirstDayOfMonth(V, U) - o + 7) % 7,
                I = Math.ceil((D + I) / 7),
                T = B && this.maxRows > I ? this.maxRows : I,
                this.maxRows = T,
                P = this._daylightSavingAdjust(new Date(V, U, 1 - D)),
                M = 0;
              M < T;
              M++
            ) {
              for (
                ...
                (H = u ? u.apply(e.input ? e.input[0] : null, [P]) : [!0, ""]),
                  (A =
                    ((z = P.getMonth() !== U) && !p) ||
                    !H[0] ||
                    (q && P < q) ||
                  ...
                  (S +=
                    ...
                    ((P.getTime() === y.getTime() &&
                      U === e.selectedMonth &&
                      e._keyEvent) ||
                    (f.getTime() === P.getTime() && f.getTime() === y.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (A
                    ...
                    (z && !d
                      ...
                      : "<a class='ui-state-default" +
                        ...
                        "' href='#' aria-current='" +
                        (P.getTime() === j.getTime() ? "true" : "false") +
                        "' data-date='" +
                        P.getDate() +
                        "'>" +
                        P.getDate() +
      ...
      _restrictMinMax: function (t, e) {
        ...
        return (
          (e = i && e < i ? i : e),
          (t = this._getMinMaxDate(t, "max")) && t < e ? t : e
        );
      },
        ...
        (s = "string" == typeof s ? s : "n,e,s,w,se,sw,ne,nw"),
          this.uiDialog
            .resizable({
              ...
              stop: function (s, n) {
                var a =
                    (r = e.uiDialog.offset()).left - e.document.scrollLeft(),
                  r = r.top - e.document.scrollTop();
          ...
          this.document.data("ui-dialog-overlays") ||
            this.document.on(
              ...
              function (t) {
                var s;
                i ||
                  (s = this._trackingInstances()[0])._allowInteraction(t) ||
                  (t.preventDefault(),
                  s._focusTabbable(),
                  ("3.4." !== e && "3.5." !== e) ||
    ...
    t.widget("ui.slider", t.ui.mouse, {
      ...
      _createHandles: function () {
        ...
        for (
          s.length > o && (s.slice(o).remove(), (s = s.slice(0, o))),
            e = s.length;
          e < o;
          e++
        )
          n.push("<span tabindex='0'></span>");
        (this.handles = s.add(t(n.join("")).appendTo(this.element))),
      ...
      _mouseCapture: function (e) {
        ...
        return (
          ...
          (i = this._normValueFromMouse(r)),
          (s = this._valueMax() - this._valueMin() + 1),
          this.handles.each(function (e) {
            var a = Math.abs(i - l.values(e));
            (a < s ||
              (s === a &&
          ...
          !1 !== this._start(e, o) &&
            ...
            n.trigger("focus"),
            (a = n.offset()),
            (r = !t(e.target).parents().addBack().is(".ui-slider-handle")),
            (this._clickOffset = r
              ? { left: 0, top: 0 }
              : {
    ...
    t.widget("ui.tabs", {
      ...
      _eventHandler: function (e) {
        ...
        (s = { oldTab: s, oldPanel: l, newTab: a ? t() : n, newPanel: r }),
          e.preventDefault(),
          n.hasClass("ui-state-disabled") ||
            n.hasClass("ui-tabs-loading") ||
            this.running ||
            (o && !i.collapsible) ||
            !1 === this._trigger("beforeActivate", e, s) ||
      ...
      load: function (e, i) {
        ...
        var n = this,
          o = this.tabs.eq(e),
          a = ((e = o.find(".ui-tabs-anchor")), this._getPanelForTab(o)),
          r = { tab: o, panel: a };
        this._isLocal(e[0]) ||
          ((this.xhr = t.ajax(this._ajaxSettings(e, i, r))),
          this.xhr &&
            ...
            this.xhr
              .done(function (t, e, o) {
                setTimeout(function () {
                  a.html(t), n._trigger("load", i, r), s(o, e);
                }, 1);
              })
              .fail(function (t, e) {
                setTimeout(function () {
    ...
    t.widget("ui.tooltip", {
      ...
      _removeDescribedBy: function (e) {
        ...
        -1 !== (i = t.inArray(i, s)) && s.splice(i, 1),
        ...
        s &&
          ((n = this._find(i))
            ...
            : (i.is("[title]") &&
              ...
              (s = t("<div>").html(o.find(".ui-tooltip-content").html()))
                .removeAttr("name")
                .find("[name]")
                .removeAttr("name"),
              ...
              this.options.track &&
                ...
                (a = this.delayedShow =
                  setInterval(function () {
                    o.is(":visible") && (l(r.of), clearInterval(a));
                  }, 13)),
  ...
  var z = t,
    ...
    W = (z.Color = function (t, e, i, s) {
      return new z.Color.fn.parse(t, e, i, s);
    }),
    F = {
      rgba: {
        props: {
  ...
  function K(t) {
    ...
    return (
      (t = t.toLowerCase()),
      B(E, function (s, n) {
        var o = (o = n.re.exec(t)) && n.parse(o);
        if (((n = n.space || "rgba"), o))
          return (
            (o = e[n](o)),
            (e[F[n].cache] = o[F[n].cache]),
            (i = e._rgba = o._rgba),
            !1
          );
      }),
      i.length
        ? ("0,0,0,0" === i.join() && z.extend(i, st.transparent), e)
        : st[t]
    );
  }
  function U(t, e, i) {
  ...
  (Y.style.cssText = "background-color:rgba(1,1,1,.5)"),
    (R.rgba = -1 < Y.style.backgroundColor.indexOf("rgba")),
    B(F, function (t, e) {
      (e.cache = "_" + t),
    ...
    ((W.fn = z.extend(W.prototype, {
      parse: function (t, e, i, s) {
        ...
        return (
          ...
          "string" === o
            ? this.parse(K(t) || st._default)
            : "array" === o
            ? (B(F.rgba.props, function (e, i) {
                a[i.idx] = q(t[i.idx], i);
              }),
              this)
            : "object" === o
                ...
                t instanceof W
                  ...
                  : function (e, i) {
                      ...
                      B(i.props, function (e, o) {
                        ...
                        n[s] &&
                          z.inArray(null, n[s].slice(0, 3)) < 0 &&
                          (null == n[s][3] && (n[s][3] = 1),
      ...
      transition: function (t, e) {
        var i = (a = W(t))._space(),
          s = F[i],
          n =
            (t = 0 === this.alpha() ? W("transparent") : this)[s.cache] ||
            s.to(t._rgba),
          o = n.slice(),
          a = a[s.cache];
        return (
      ...
      toRgbaString: function () {
        var t = "rgba(",
          e = z.map(this._rgba, function (t, e) {
      ...
      toHslaString: function () {
        var t = "hsla(",
          e = z.map(this.hsla(), function (t, e) {
            return (
              null == t && (t = 2 < e ? 1 : 0),
    ...
    (F.hsla.from = function (t) {
      ...
      return (
        (t = t[3]),
        (s = 2 * s - (i = s <= 0.5 ? s * (1 + i) : s + i - s * i)),
        [
          Math.round(255 * U(s, i, e + 1 / 3)),
          Math.round(255 * U(s, i, e)),
          Math.round(255 * U(s, i, e - 1 / 3)),
          t,
        ]
      );
    ...
    B(F, function (t, e) {
      ...
      (W.fn[t] = function (t) {
        if ((n && !this[s] && (this[s] = n(this._rgba)), void 0 === t))
          return this[s].slice();
        var e = j(t),
          a = "array" === e || "object" === e ? t : arguments,
          r = this[s].slice();
        return (
          B(i, function (t, i) {
            null == (t = a["object" === e ? t : i.idx]) && (t = r[i.idx]),
              (r[i.idx] = q(t, i));
          }),
          o ? (((t = W(o(r)))[s] = r), t) : W(r)
        );
        ...
        B(i, function (e, i) {
          W.fn[e] ||
            (W.fn[e] = function (s) {
              var n,
                o = j(s),
                a = "alpha" === e ? (this._hsla ? "hsla" : "rgba") : t,
                r = this[a](),
                l = r[i.idx];
              return "undefined" === o
                ? l
                : ("function" === o && (o = j((s = s.call(this, l)))),
                  null == s && i.empty
                    ? this
                    : ("string" === o &&
                        (n = N.exec(s)) &&
          ...
          (z.cssHooks[e] = {
            set: function (t, i) {
              var s,
                n,
                o = "";
              if ("transparent" !== i && ("string" !== j(i) || (s = K(i)))) {
                if (((i = W(s || i)), !R.rgba && 1 !== i._rgba[3])) {
                  for (
                    n = "backgroundColor" === e ? t.parentNode : t;
                    ("" === o || "transparent" === o) && n && n.style;

                  )
                    try {
                      (o = z.css(n, "backgroundColor")), (n = n.parentNode);
                    } catch (t) {}
            ...
            (z.fx.step[e] = function (t) {
              t.colorInit ||
                ((t.start = W(t.elem, e)),
                (t.end = W(t.end)),
                (t.colorInit = !0)),
                z.cssHooks[e].set(t.elem, t.start.transition(t.end, t.pos));
            });
        });
    })(
      "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
    ),
    (z.cssHooks.borderColor = {
      expand: function (t) {
        var e = {};
        return (
  ...
  (t.effects = { effect: {} }),
      ...
      function (e, i) {
        t.fx.step[i] = function (t) {
          (("none" !== t.end && !t.setAttr) || (1 === t.pos && !t.setAttr)) &&
            (z.style(t.elem, i, t.end), (t.setAttr = !0));
        };
      },
    ),
    t.fn.addBack ||
      ...
      return this.queue(function () {
        var i = t(this),
          ...
          n = (n = o.children ? i.find("*").addBack() : i).map(function () {
            return { el: t(this), start: rt(this) };
          }),
          a = function () {
            t.each(G, function (t, s) {
              e[s] && i[s + "Class"](e[s]);
            });
          };
        a(),
      ...
      toggleClass:
        ...
        function (e, i, s, n, o) {
          return "boolean" == typeof i || void 0 === i
            ...
            : t.effects.animateClass.call(this, { toggle: e }, i, s, n);
        }),
    ...
    t.expr &&
      ...
      (t.expr.pseudos.animated =
        ((J = t.expr.pseudos.animated),
        function (e) {
          return !!t(e).data(at) || J(e);
        })),
    !1 !== t.uiBackCompat &&
      t.extend(t.effects, {
        save: function (t, e) {
    ...
    t.fn.extend({
      ...
      show:
        ...
        function (t) {
          return ht(t)
            ...
            : (((t = lt.apply(this, arguments)).mode = "show"),
      ...
      hide:
        ...
        function (t) {
          return ht(t)
            ...
            : (((t = lt.apply(this, arguments)).mode = "hide"),
              this.effect.call(this, t));
        }),
      toggle:
        ((Z = t.fn.toggle),
        function (t) {
          return ht(t) || "boolean" == typeof t
            ? Z.apply(this, arguments)
            : (((t = lt.apply(this, arguments)).mode = "toggle"),
              this.effect.call(this, t));
        }),
      cssUnit: function (e) {
        var i = this.css(e),
      ...
      transfer: function (e, i) {
        var s = t(this),
          n = "fixed" === (l = t(e.to)).css("position"),
          o = t("body"),
          a = n ? o.scrollTop() : 0,
          r = n ? o.scrollLeft() : 0,
          l =
            ((o = {
              top: (o = l.offset()).top - a,
              left: o.left - r,
    ...
    (t.fx.step.clip = function (e) {
      e.clipInit ||
        ...
        "string" == typeof e.end && (e.end = ct(e.end, e.elem)),
        (e.clipInit = !0)),
        t(e.elem).cssClip({
    ...
    t.effects.define("bounce", function (e, i) {
      ...
      for (
        ...
        ((s = {})[f] = (g ? "-=" : "+=") + h),
          o.animate(s, d, p).animate(n, d, p),
          (h = a ? 2 * h : h / 2);
      a &&
        (((s = { opacity: 0 })[f] = (g ? "-=" : "+=") + h), o.animate(s, d, p)),
        o.queue(i),
    ...
    t.effects.define("clip", "hide", function (e, i) {
      var s = {},
        n = t(this),
        o =
          (a = "both" === (r = e.direction || "vertical")) ||
          "horizontal" === r,
        a = a || "vertical" === r,
        r = n.cssClip();
      (s.clip = {
        top: a ? (r.bottom - r.top) / 2 : r.top,
        right: o ? (r.right - r.left) / 2 : r.right,
        bottom: a ? (r.bottom - r.top) / 2 : r.bottom,
        left: o ? (r.right - r.left) / 2 : r.left,
      }),
        t.effects.createPlaceholder(n),
        "show" === e.mode && (n.cssClip(s.clip), (s.clip = r)),
        n.animate(s, {
          queue: !1,
          duration: e.duration,
          easing: e.easing,
    ...
    t.effects.define("drop", "hide", function (e, i) {
      ...
      t.effects.createPlaceholder(s),
        (o =
          e.distance || s["top" == a ? "outerHeight" : "outerWidth"](!0) / 2),
        (h[a] = r + o),
        n && (s.css(h), (h[a] = l + o), (h.opacity = 1)),
        s.animate(h, {
          queue: !1,
          duration: e.duration,
          easing: e.easing,
    ...
    t.effects.define("fold", "hide", function (e, i) {
      ...
      r && (a = (parseInt(r[1], 10) / 100) * f[o ? 0 : 1]),
        ...
        (p.clip[l[1]] = 0),
        n &&
          (s.cssClip(p.clip), c && c.css(t.effects.clipToBox(p)), (p.clip = u)),
        s
          .queue(function (i) {
            c &&
              c
    ...
    t.effects.define("size", function (e, i) {
      var s,
        ...
        d = n.css("position"),
        p = n.position(),
        f = t.effects.scaledDimensions(n),
        g = e.from || f,
        m = e.to || t.effects.scaledDimensions(n, 0);
      t.effects.createPlaceholder(n),
        "show" === l && ((l = g), (g = m), (m = l)),
        (s = {
        ...
        ("box" !== c && "both" !== c) ||
          (s.from.y !== s.to.y &&
            ((g = t.effects.setTransition(n, a, s.from.y, g)),
            (m = t.effects.setTransition(n, a, s.to.y, m))),
          s.from.x !== s.to.x &&
            ((g = t.effects.setTransition(n, r, s.from.x, g)),
            (m = t.effects.setTransition(n, r, s.to.x, m)))),
        ("content" !== c && "both" !== c) ||
          (s.from.y !== s.to.y &&
            ((g = t.effects.setTransition(n, o, s.from.y, g)),
            (m = t.effects.setTransition(n, o, s.to.y, m)))),
        u &&
        ...
        ("content" !== c && "both" !== c) ||
          ...
          n.find("*[width]").each(function () {
            var i = t(this),
              n = {
                height: (o = t.effects.scaledDimensions(i)).height * s.from.y,
                width: o.width * s.from.x,
                outerHeight: o.outerHeight * s.from.y,
                outerWidth: o.outerWidth * s.from.x,
              },
              o = {
                height: o.height * s.to.y,
                width: o.width * s.to.x,
                outerHeight: o.height * s.to.y,
                outerWidth: o.width * s.to.x,
              };
            s.from.y !== s.to.y &&
              ((n = t.effects.setTransition(i, a, s.from.y, n)),
              (o = t.effects.setTransition(i, a, s.to.y, o))),
              s.from.x !== s.to.x &&
                ((n = t.effects.setTransition(i, r, s.from.x, n)),
                (o = t.effects.setTransition(i, r, s.to.x, o))),
        ...
        n.animate(m, {
          ...
          complete: function () {
            var e = n.offset();
            0 === m.opacity && n.css("opacity", g.opacity),
              h ||
                (n.css("position", "static" === d ? "relative" : d).offset(e),
    ...
    t.effects.define("scale", function (e, i) {
      ...
      (n =
        ...
        t.effects.effect.size.call(this, n, i);
    }),
    ...
    t.effects.define("pulsate", "show", function (e, i) {
      var s = t(this),
        n = "show" === (h = e.mode),
        o = 2 * (e.times || 5) + (n || "hide" === h ? 1 : 0),
        a = e.duration / o,
        r = 0,
        l = 1,
        h = s.queue().length;
      for (
        (!n && s.is(":visible")) || (s.css("opacity", 0).show(), (r = 1));
        l < o;
        l++
      )
        s.animate({ opacity: r }, a, e.easing), (r = 1 - r);
      s.animate({ opacity: r }, a, e.easing),
        s.queue(i),
        t.effects.unshift(s, h, 1 + o);
    }),
